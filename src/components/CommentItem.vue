...
<template>
    <div class="contain">
        ...
        <div class="comment-text" v-for="(item, index) in topCommentList" :Key="index">
            <div class="comment-name" style="color: gray;">{{ item.commentName }}</div>
            <div class="comment-content">{{ item.comment }}</div>
            <div class="comment-footer">
                <span class="comment-time" style="color: gray;">{{ formatDateTime(item.commentTime) }}</span>
            ...
            <div class="child-comment" v-for="(child, index) in item.childList" :Key="index">
                <div class="comment-header">
                    ...
                    <span style="color: gray;">回复</span>
                    <span>{{ child.commentedName }}</span>
                </div>
                <div class="comment-content">{{ child.comment }}</div>
                <div class="comment-footer">
                    <span class="comment-time"  style="color: gray;">{{ formatDateTime(child.commentTime) }}</span>
                    <span class="comment-resend" @click="resend(item)">回复</span>
                </div>
            </div>
        </div>
